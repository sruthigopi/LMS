...
const StudentLearningData = require('./src/model/StudentLearningData');
...
app.post('/studentlogin', (req, res) => {
	...
	StudentData.findOne(
		{ studentemail: studentData.studentemail, studentpwd: studentData.studentpwd },
		(err, studentData) => {
			if (studentData) {
...
app.post('/trainerlogin', (req, res) => {
	...
	TrainerData.findOne(
		{ traineremail: trainerData.traineremail, trainerpwd: trainerData.trainerpwd },
		(err, trainerData) => {
			if (trainerData) {
...
app.get('/aprovestulist', function(req, res) {
	res.header('Access-Control-Allow-Origin', '*');
	res.header('Access-Control-Allow-Methods: POST,PATCH, GET, DELETE, PUT, OPTIONS');
	StudentData.find({ isApproved: 'true' }).then(function(students) {
...
app.get('/aprovetralist', verifyToken, function(req, res) {
	res.header('Access-Control-Allow-Origin', '*');
	res.header('Access-Control-Allow-Methods: POST,PATCH, GET, DELETE, PUT, OPTIONS');
	TrainerData.find({ isApproved: 'true' }).then(function(trainers) {
...
app.get('/studentlearningdata', function(req, res) {
	res.header('Access-Control-Allow-Origin', '*');
	res.header('Access-Control-Allow-Methods: GET, POST, PUT, DELETE');
	StudentLearningData.find().then(function(body) {
		res.send(body);
	});
});
