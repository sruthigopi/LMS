...
@Component({
  selector: 'app-addcsalearningmaterial',
  templateUrl: './addcsalearningmaterial.component.html',
  styleUrls: ['./addcsalearningmaterial.component.css']
})
export class AddcsalearningmaterialComponent implements OnInit {
    ...
    if(event.target.files.length>0){
      ...
      oSubmit(){
        ...
        formdata.append('file',this.image);
         ...
         this.materialService.Addmaterialcsa(formdata);
         console.log(formdata);
         alert('sucessfully added material');
         this.router.navigate(['learmatcsa']);
}
}
