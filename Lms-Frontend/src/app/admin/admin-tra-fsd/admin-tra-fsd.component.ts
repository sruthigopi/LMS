...
@Component({
  selector: 'app-admin-tra-fsd',
  templateUrl: './admin-tra-fsd.component.html',
  styleUrls: ['./admin-tra-fsd.component.css']
})
export class AdminTraFsdComponent implements OnInit {
  trainerdtls={
    tracouid:''
  }
  ...
  ngOnInit(): void {
    this.accessService.aprovedfsdTrainer().subscribe((data)=>{
