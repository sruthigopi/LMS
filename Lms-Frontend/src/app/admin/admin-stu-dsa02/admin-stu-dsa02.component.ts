...
@Component({
  selector: 'app-admin-stu-dsa02',
  templateUrl: './admin-stu-dsa02.component.html',
  styleUrls: ['./admin-stu-dsa02.component.css']
})
export class AdminStuDsa02Component implements OnInit {
  students:StudentModel |any;
  nodata=false;
  constructor(private accessService :AccessService ,private router:Router) { }

  ngOnInit(): void {
    this.accessService.aprovedStuListdsa02().subscribe((data)=>{
