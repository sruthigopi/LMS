...
@Component({
  selector: 'app-admin-tra-csa',
  templateUrl: './admin-tra-csa.component.html',
  styleUrls: ['./admin-tra-csa.component.css']
})
export class AdminTraCsaComponent implements OnInit {
  trainerdtls={
    tracouid:''
  }
  ...
  ngOnInit(): void {
    this.accessService.aprovedcsaTrainer().subscribe((data)=>{
