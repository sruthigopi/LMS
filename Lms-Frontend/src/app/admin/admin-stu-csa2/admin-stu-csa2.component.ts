...
@Component({
  selector: 'app-admin-stu-csa2',
  templateUrl: './admin-stu-csa2.component.html',
  styleUrls: ['./admin-stu-csa2.component.css']
})
export class AdminStuCsa2Component implements OnInit {
  students:StudentModel |any;
  nodata=false;
  constructor(private accessService :AccessService ,private router:Router) { }

  ngOnInit(): void {
    this.accessService.aprovedStuListcsa02().subscribe((data)=>{
